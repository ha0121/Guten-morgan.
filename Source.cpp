    ...
    while (tempCongTy != nullptr) {
        ...
        while (tempTuyen != nullptr) {
            if (tempTuyen->maTuyen == maTuyenCanTim) {
                std::cout << "Tim thay tuyen xe buyt co ma " << maTuyenCanTim << " cua cong ty " << tempCongTy->tenCty << endl;
                return;
            }
...
void TimTuyenXeBuyt(CongTy* danhSachCongTy, const string& tenTuyenCanTim) {
    ...
    while (tempCongTy != nullptr) {
        ...
        while (tempTuyen != nullptr) {
            if (tempTuyen->tenTuyen == tenTuyenCanTim) {
                cout << "Tim thay tuyen xe buyt co ten " << tenTuyenCanTim << " cua cong ty " << tempCongTy->tenCty << endl;
                return;
            }
            tempTuyen = tempTuyen->nextTuyen;
        }
   ...
   cout << "Khong tim thay tuyen xe buyt co ten " << tenTuyenCanTim << " trong he thong." << endl;
}
//thêm tuyến xe bus
void ThemTuyenChoCongTy(CongTy* danhSachCongTy, int maCongTyThemTuyen) {
    ...
    while (tempCongTy != nullptr) {
        if (tempCongTy->maCty == maCongTyThemTuyen) {
            ...
            cout << "Da them tuyen xe buyt cho cong ty co ma " << maCongTyThemTuyen << endl;
            return;
        }
        tempCongTy = tempCongTy->nextCty;
    }

    cout << "Khong tim thay cong ty co ma " << maCongTyThemTuyen << " trong he thong." << endl;
}
